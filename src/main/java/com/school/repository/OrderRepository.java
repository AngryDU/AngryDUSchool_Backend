...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    @Modifying
    @Transactional
    @Query("update Order o set o.purchase = :purchase where o.id = :order_id")
    int updatePurchaseForOrder(@Param("purchase") Order.Purchase purchase, @Param("order_id") UUID orderId);
}
